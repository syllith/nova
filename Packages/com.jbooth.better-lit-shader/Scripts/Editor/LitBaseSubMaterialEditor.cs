...
namespace JBooth.BetterLit
{
   ...
   public class StackableTerrainAlignedDetailEditor : SubShaderMaterialEditor
   {
      LitBaseStub stub = null;
      public override void OnGUI(MaterialEditor materialEditor,
          ShaderGUI shaderGUI,
          ...
          Material mat)
      {
         ...
         stub.DoTerrainAlignedDetail(materialEditor, props);
         stub.DoTerrainTintDetail(materialEditor, props);
      }
        
   }

   public class StackableVertexWindEditor : SubShaderMaterialEditor
   {
      LitBaseStub stub = null;
      public override void OnGUI(MaterialEditor materialEditor,
         ShaderGUI shaderGUI,
         ...
         Material mat)
      {
         ...
         stub.DoVertexWind(materialEditor, props);
      }
   }
